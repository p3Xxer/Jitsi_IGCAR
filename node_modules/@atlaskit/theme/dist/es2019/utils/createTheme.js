...
export function createTheme(defaultGetTokens) {
  ...
  const ThemeContext = /*#__PURE__*/createContext(defaultGetTokens); // The Theme Consumer takes a function as its child - this function takes tokens, and the
  ...
  function Consumer(props) {
    ...
    const themeFn = theme || emptyThemeFn; // @ts-ignore See issue for more info: https://github.com/Microsoft/TypeScript/issues/10727
    ...
    const tokens = themeFn(themeProps); // We add a fragment to ensure we don't break people upgrading.
