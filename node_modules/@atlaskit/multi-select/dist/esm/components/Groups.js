...
var renderNoItemsMessage = function renderNoItemsMessage(noMatchesFound) {
  return /*#__PURE__*/React.createElement(NoMatches, null, noMatchesFound);
};
...
var renderGroups = function renderGroups(_ref3) {
  ...
  var renderedGroups = groups.map(function (group, groupIndex) {
    ...
    return filteredItems.length > 0 ? /*#__PURE__*/React.createElement(Group, {
  ...
  return renderedGroups.length > 0 || shouldAllowCreateItem ? /*#__PURE__*/React.createElement(GroupsContainer, {
    hasFooter: hasFooter
