...
var renderNoItemsMessage = function renderNoItemsMessage(noMatchesFound) {
  return /*#__PURE__*/_react.default.createElement(_NoMatch.default, null, noMatchesFound);
};

var renderLoadingMessage = function renderLoadingMessage(loadingMessage) {
  return /*#__PURE__*/_react.default.createElement(_InitialLoading.default, {
    "aria-live": "polite",
    role: "status"
  }, loadingMessage);
};
...
var renderGroups = function renderGroups(_ref3) {
  ...
  var renderedGroups = groups.map(function (group, groupIndex) {
    ...
    return filteredItems.length > 0 ? /*#__PURE__*/_react.default.createElement(_droplist.Group, {
  ...
  return renderedGroups.length > 0 || shouldAllowCreateItem ? /*#__PURE__*/_react.default.createElement(_GroupsContainer.default, {
    hasFooter: hasFooter
