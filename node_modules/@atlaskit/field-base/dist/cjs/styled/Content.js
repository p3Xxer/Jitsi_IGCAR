...
var getLineHeight = function getLineHeight(props) {
  ...
  return currentLineHeight / (0, _constants.fontSize)();
};
...
var getHoverState = function getHoverState(props) {
  ...
  return (0, _styledComponents.css)(["\n    &:hover {\n      background-color: ", ";\n    }\n  "], (0, _theme.getBackgroundColorHover)(props));
};
...
var Content = _styledComponents.default.div.withConfig({
  ...
  return props.isFocused ? (0, _theme.getBackgroundColorFocus)(props) : (0, _theme.getBackgroundColor)(props);
}, function (props) {
  return props.isFocused ? (0, _theme.getBorderColorFocus)(props) : (0, _theme.getBorderColor)(props);
}, borderRadius, getBorderStyle, getColor, _constants.fontSize, getLineHeight, transitionDuration, transitionDuration, getBorderAndPadding, getHoverState, getDisabledState);
