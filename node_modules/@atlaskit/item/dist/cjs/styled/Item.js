...
var getItemState = function getItemState(stateName) {
  return function (_ref) {
    ...
    var stateStyles = (0, _theme.getThemeStyle)(theme[_theme.themeNamespace], stateName);
...
var getPadding = function getPadding(_ref2) {
  ...
  var _getThemeStyle = (0, _theme.getThemeStyle)(theme[_theme.themeNamespace], paddingKey, 'padding'),
...
var getHeightStyles = function getHeightStyles(_ref3) {
  ...
  var height = (0, _theme.getThemeStyle)(theme[_theme.themeNamespace], heightKey, 'height');
...
var getWidthStyles = function getWidthStyles(_ref4) {
  ...
  var width = (0, _theme.getThemeStyle)(theme[_theme.themeNamespace], widthKey, 'width');

  if (!width) {
    return '';
  }

  return typeof width === 'number' ? (0, _styledComponents.css)(["\n        width: ", "px;\n      "], width) : (0, _styledComponents.css)(["\n        width: ", ";\n      "], width);
...
var getInteractiveStyles = function getInteractiveStyles(_ref5) {
  ...
  if (isDragging) {
    return (0, _styledComponents.css)(["\n      ", " box-shadow: 0 4px 8px -2px ", ",\n        0 0 1px ", ";\n    "], getItemState('dragging'), _colors.N60A, _colors.N60A);
  }

  var standardFocus = (0, _styledComponents.css)(["\n    &:focus {\n      box-shadow: 0 0 0 2px\n        ", " inset;\n      text-decoration: none;\n    }\n  "], (0, _theme.getThemeStyle)(theme[_theme.themeNamespace], 'outline', 'focus'));
