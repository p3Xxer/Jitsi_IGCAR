...
export default class Content extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "escapeIsHeldDown", false);
    ...
    _defineProperty(this, "determineKeylines", rafSchedule(() => {
    ...
    _defineProperty(this, "getScrollContainer", ref => {
      if (!ref) {
        return;
      }
    ...
    _defineProperty(this, "handleKeyDown", event => {
      ...
      const isEscapeKeyPressed = event.key === 'Escape'; // avoid consumers accidentally closing multiple modals if they hold escape.
    ...
    _defineProperty(this, "handleStackChange", stackIndex => {
      const {
        onStackChange
      } = this.props;
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    const {
      stackIndex
    } = this.props; // update focus scope and let consumer know when stack index has changed
  ...
  render() {
    ...
    return jsx(Container, {
      ...
      testId: testId
    }), this.scrollContainer instanceof HTMLElement ? jsx(TouchScrollable, null, touchRef => jsx(Body, _extends({
      tabIndex: showContentFocus ? 0 : undefined,
      css: bodyStyles(shouldScroll)
    }, !Body.hasOwnProperty('styledComponentId') ? {
      ref: mergeRefs([touchRef, this.getScrollContainer])
    } : {
      innerRef: mergeRefs([touchRef, this.getScrollContainer])
    }), children)) : jsx(Body, _extends({
      tabIndex: showContentFocus ? 0 : undefined,
      css: bodyStyles(shouldScroll)
    }, !Body.hasOwnProperty('styledComponentId') ? {
