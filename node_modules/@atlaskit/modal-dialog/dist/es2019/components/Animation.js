...
const verticalOffset = 16; // Animation
// ==============================
...
export const Animation = ({
  ...
  const adjustedStatus = hasEntered && unadjustedStatus === 'exited' ? 'entering' : unadjustedStatus; // Fade styles
  ...
  return children({
    fade: { ...fadeBaseStyles,
      ...fadeTransitionStyles[adjustedStatus]
    },
    slide: { ...slideBaseStyles,
      ...slideTransitionStyles[adjustedStatus]
    }
  });
});