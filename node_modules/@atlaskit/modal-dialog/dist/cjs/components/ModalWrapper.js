...
var _ModalTransition = require("./ModalTransition");

var _StackConsumer = _interopRequireDefault(require("./StackConsumer"));
...
var ModalWrapper = /*#__PURE__*/function (_React$Component) {
  ...
  function ModalWrapper() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onModalClosed", function (onExited) {
      return function (e) {
        if (onExited) {
          onExited();
        }
  ...
  (0, _createClass2.default)(ModalWrapper, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_ModalTransition.ModalTransitionConsumer, null, function (_ref) {
        var isOpen = _ref.isOpen,
            onExited = _ref.onExited;
        return /*#__PURE__*/_react.default.createElement(_portal.default, {
          zIndex: _constants.layers.modal()
        }, /*#__PURE__*/_react.default.createElement(_StackConsumer.default, {
          isOpen: isOpen
        }, function (naturalStackIndex) {
          return /*#__PURE__*/_react.default.createElement(_Modal.default, (0, _extends2.default)({}, _this2.props, {
            isOpen: isOpen,
